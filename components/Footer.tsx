      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1">
            <div className="flex items-center space-x-2 mb-4">
              ...
              <span className="font-bold text-white text-lg">SUBWAY SOUNDS</span>
            </div>
            <p className="text-sm text-gray-400">
              Your comprehensive guide to NYC subway stations, real-time arrivals, and subway culture.
            </p>
            <p className="text-xs text-gray-500 mt-3">
              Subway Sounds Media LLC
              <br />
              New York City, USA
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <Link href="/lines" className="hover:text-white transition-colors">
                  Subway Lines
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link href="/subway-map" className="hover:text-white transition-colors">
                  Interactive Map
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <div className="mt-6">
              ...
              <div className="flex space-x-4">
                {/* Social media icons - can be added later */}
                <a
                  href="#"
        ...
        <div className="mt-8 pt-8 border-t border-gray-800">
          ...
          <p className="text-xs text-gray-600 mt-4 text-center md:text-left">
            This site displays Google AdSense advertisements and may contain affiliate links.
